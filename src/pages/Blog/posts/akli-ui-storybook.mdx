...
image: /images/blog/storybook-button-docs-full.webp
---

<Image src="/images/blog/storybook-button-docs-medium.webp" srcSet="/images/blog/storybook-button-docs-medium.webp 800w, /images/blog/storybook-button-docs-full.webp 1200w" alt="Storybook's sidebar listing every component, with the Button component's docs page open showing its props table and a live example" caption="The component library, browsable at storybook.akli.dev" priority />
...
<Image src="/images/blog/storybook-header-public-variant-medium.webp" srcSet="/images/blog/storybook-header-public-variant-medium.webp 800w, /images/blog/storybook-header-public-variant-full.webp 1200w" alt="The Header component's public variant, rendered in Storybook" caption="Header's public variant, viewed in Storybook" />
