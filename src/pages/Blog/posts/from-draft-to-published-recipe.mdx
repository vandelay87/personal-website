...
image: /images/blog/recipes-full.webp
---

<Image src="/images/blog/recipes-medium.webp" srcSet="/images/blog/recipes-medium.webp 800w, /images/blog/recipes-full.webp 1200w" alt="The recipes section of akli.dev showing a grid of recipe cards" caption="The recipes section, running on akli.dev" priority />
...
```mermaid
graph LR
    accTitle: Recipe cover image upload pipeline
    accDescr: The browser asks the image handler API for a presigned upload URL, then uploads the original file straight to the S3 uploads bucket using that URL. The upload triggers an S3 ObjectCreated event that invokes the resizer Lambda, which writes WebP variants to the S3 processed bucket and marks the image ready in DynamoDB.
...
<Image src="/images/blog/recipe-editor-medium.webp" srcSet="/images/blog/recipe-editor-medium.webp 800w, /images/blog/recipe-editor-full.webp 1200w" alt="The admin recipe editor with a recipe open for editing" caption="The admin editor I use to write recipes" maxWidth="600px" />
