...
<Image src="/images/blog/pokedex-desktop.webp" alt="Pokedex app showing the Pokemon list and detail panel" caption="The finished Pokedex, running on akli.dev" priority />
