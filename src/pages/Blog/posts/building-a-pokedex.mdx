...
image: /images/blog/pokedex-desktop-full.webp
---

<Image src="/images/blog/pokedex-desktop-medium.webp" srcSet="/images/blog/pokedex-desktop-medium.webp 800w, /images/blog/pokedex-desktop-full.webp 1200w" alt="Pokedex app showing the Pokemon list and detail panel" caption="The finished Pokedex, running on akli.dev" priority />
...
You can try it at [pokedex.akli.dev](https://pokedex.akli.dev).
...
```mermaid
graph TD
    accTitle: Pokedex CDK stack architecture
    accDescr: AkliCertificateStack in us-east-1 provisions the Route 53 hosted zone and ACM certificates for akli.dev and api.akli.dev. PokedexStack in eu-west-2 holds the DynamoDB pokemon table, the Lambda handler, a seeder Lambda that loads pokemon.json into DynamoDB, and an HTTP API Gateway exposing GET /pokedex/pokemon endpoints, which the handler Lambda serves from the table. ApiStack in eu-west-2 wires a CloudFront distribution and Route 53 record for api.akli.dev, routed by the certificate and hosted zone, so CloudFront forwards /pokedex/* requests to the API Gateway.
    subgraph "AkliCertificateStack (us-east-1)"
...
<Image src="/images/blog/pokedex-mobile-thumb.webp" srcSet="/images/blog/pokedex-mobile-thumb.webp 400w, /images/blog/pokedex-mobile-medium.webp 800w" alt="Pokedex mobile view showing the detail overlay with stat bars" caption="The mobile detail overlay with animated stat bars" maxWidth="400px" />
...
You can try the Pokedex at [pokedex.akli.dev](https://pokedex.akli.dev).
